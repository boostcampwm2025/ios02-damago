...
USER_NOT_FOUND = ErrorInfo("User not found", 404)
USER_NOT_FOUND_TOKEN_INVALID = ErrorInfo("User not found (Token Invalid)", 404)
TARGET_USER_NOT_FOUND_INVALID_CODE = ErrorInfo("Target user not found (Invalid Code)", 404)
COUPLE_NOT_FOUND = ErrorInfo("Couple not found", 404)
COUPLE_DOCUMENT_NOT_FOUND = ErrorInfo("Couple document not found", 404)
QUESTION_NOT_FOUND = ErrorInfo("Question not found", 404)
DAMAGO_NOT_FOUND = ErrorInfo("Damago not found", 404)
...
UNAUTHORIZED_ADMIN_REQUIRED = ErrorInfo("Unauthorized: Admin access required", 403)
